...
proj_1 = Projects('Machine learning approaches for Cyber Security',
                  'As we use internet more, the data produced by us is enormous. But are these data being secure?.',
                  'Bharanidharan Shanmugam')
proj_2 = Projects('Informetrics applications in multidisciplinary domain',
                  ...
                  'Yakub Sebastian ')
proj_3 = Projects('Development of a Virtual Reality System to Test Binaural Hearing',
                  ...
                  'Sami Azam')
proj_4 = Projects('Current trends on cryptomining and its potential impact on cryptocurrencies',
                  ...
                  'Sami Azam')
proj_5 = Projects('Artificial Intelligence in Health Informatics',
                  ...
                  'Asif Karim')
proj_6 = Projects('Unsupervised Model Development from Autism Screening Data ',
                  ...
                  'Asif Karim')
proj_7 = Projects('Applying Artificial Intelligence to solve real world problems',
